...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LedStates_message_member_array[2] = {
  {
    "led_number",  // name
    ...
    offsetof(my_robot_interfaces::msg::LedStates, led_number),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_robot_interfaces::msg::LedStates, led_state),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
