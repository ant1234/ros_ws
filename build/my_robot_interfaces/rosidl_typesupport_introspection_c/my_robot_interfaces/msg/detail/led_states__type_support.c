...
static rosidl_typesupport_introspection_c__MessageMember my_robot_interfaces__msg__LedStates__rosidl_typesupport_introspection_c__LedStates_message_member_array[2] = {
  {
    "led_number",  // name
    ...
    offsetof(my_robot_interfaces__msg__LedStates, led_number),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_robot_interfaces__msg__LedStates, led_state),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
