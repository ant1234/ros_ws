...
class TurtleControllerNode(Node):
    ...
    def calculate_closest_turtle(self, turtle):
    ...
    def callback_alive_turtles(self, msg):
        ...
        if len(msg.turtles) > 0:
            ...
            turtle_distances = [(index, self.calculate_closest_turtle(turtle)) for index, turtle in enumerate(msg.turtles)]
            sorted_distances = sorted(turtle_distances, key=lambda x: x[1])
            self.turtle_to_catch_  = msg.turtles[sorted_distances[0][0]]
